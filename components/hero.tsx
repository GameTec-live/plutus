                    ...
                    <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                            <h1 className="text-5xl font-semibold tracking-tight text-pretty text-foreground sm:text-7xl">
                                Funding projects you care about.
                            </h1>
                            <p className="mt-8 text-lg font-medium text-pretty text-muted-foreground sm:max-w-md sm:text-xl/8 lg:max-w-none">
                                Find projects or submit your own to find support
                            </p>
                            <div className="mt-10 flex items-center gap-x-6">
                                <Link
                                    href="/#explore"
                                    className="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-primary-foreground shadow-xs hover:bg-primary/80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary dark:bg-primary dark:hover:bg-primary/80 dark:focus-visible:outline-primary"
                                >
                                    Explore
                                </Link>
                                <Link
                                    href="/create"
                                    className="text-sm/6 font-semibold text-muted-foreground hover:text-muted-foreground/80 inline-flex items-center"
                                >
                                    Submit your own{" "}
